...
use libafl::{
    ...
    mutators::{StdScheduledMutator, havoc_mutations},
...
fn main() {
    ...
    // Feedback to rate the interesting-ness of an input
    ...
    // A queue policy to get test cases from the corpus
    ...
    // Generator of printable byte arrays of max size 32
